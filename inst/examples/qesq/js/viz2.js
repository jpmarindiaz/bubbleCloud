...
function createHtmlText(label, description, imgurl) {
    ...
    text = htmllabel + htmlimage + htmldescription;
    return (text)
};
...
function drawGraph(graph) {
    ...
    d3.selectAll(".node")
        .on("click", function(d, i) {
            ...
            text = createHtmlText(d.label, d.Ocupació n, d.imgurl);
...
function drawNodes(nodes) {
    ...
    var sizeMin = d3.min(nodes, function(d) {
        return d.value2;
    });
    console.log(sizeMax)
    ...
    var node = d3.select("#plot").selectAll(".node")
        ...
        .attr("r", function(d, i) {
            return scalesize(d.value2);
        })
        .style("fill", function(d, i) {
            return color(d.value1);
        })
    // .style("fill", "000");
